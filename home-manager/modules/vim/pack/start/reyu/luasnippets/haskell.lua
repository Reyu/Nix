...
rec_field = function(args, _, _, user_args1)
    ...
    return sn(nil, c(1, {
        t("}", virtText("Add another field?")), sn(nil, {
            t(", " .. prefix), i(1), t(" :: "), i(2, "Text"), t({"", "    "}),
...
ls.add_snippets("haskell", {
    s({trig = "header", name = "Module Header"}, fmt([[
            {{- |
            Module      :  {moduleName}
            Description :  {summary}
        ...
        license = c(4, {
            ...
            t("bsd-3-clause",
              virtText('BSD 3-clause "New" or "Revised" license')),
            ...
            t("cc-by-sa-4.0",
              virtText("Creative Commons Attribution Share Alike 4.0")),
            ...
            t("ncsa",
              virtText("University of Illinois/NCSA Open Source License")),
            t("unlicense", virtText("The Unlicense")),
            t("zlib", virtText("zLib License")), i(nil)
        }),
        maintainer = c(5, {
            fn(function()
        ...
        stability = c(6, {
            t("unstable"), t("experimental"), t("provisional"), t("stable"),
            t("frozen")
        }),
        portability = c(7, {t("portable"), t("non-portable"), i(nil)}),
        description = i(8),
        done = i(0)
        ...
        c(3, {t(""), sn(nil, {t(" as "), i(1, "T")})},
          virtText("Rename import?")),
        c(4, {t(""), sn(nil, {t(" ("), i(1), t(")")})},
          virtText("Restrict scope?"))
    }), s({
        trig = "data",
        name = "Data Type",
        dscr = "Create a new Data type with an arbitrary number of fields"
    }, {
        t("data "), i(1, "Name"), t(" = "), dl(2, l._1, 1), t({"", "    { "}),
        c(3, {l(l._1:lower(), 1), l("_" .. l._1:lower(), 1), i(nil)},
          virtText("Select a prefix")), i(4, "Id"), t(" :: "), i(5, "Text"),
        t({"", "    "}), d(6, rec_field, {3})
    }), s({trig = "deriving", name = "Deriving Clause"}, {
        t("  deriving "), c(1, {
            t(""), t("stock "), t("anyclass "),
            sn(nil, {r(1, "deriving_class"), t(" ")})
        }, virtText("Set Deriving Class")), t("("), i(2, "Show, Eq"), t(")")
    })
}, {key = "haskell"})
