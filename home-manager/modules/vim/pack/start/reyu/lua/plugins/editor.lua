return {
    {
        ...
        keys = {
            { '|', '<Cmd>Neotree action=focus source=filesystem reveal=true<CR>',
                silent = true, noremap = true, desc = 'Toggle NeoTree'},
            { '<Leader>tt', '<Cmd>Neotree action=show source=filesystem toggle=true reveal=true position=left<CR>',
                silent = true, noremap = true, desc = 'Toggle NeoTree'},
            { '<Leader>tb', '<Cmd>Neotree action=show source=buffers toggle=true position=right<CR>',
                silent = true, noremap = true, desc = 'Toggle buffer list'},
            { '<Leader>ts', '<Cmd>Neotree action=focus source=git_status position=float<CR>',
    ...
    },
    {
        ...
        opts = function(_, opts)
            ...
            opts.fold_virt_text_handler = function(virtText, lnum, endLnum, width, truncate, fold)
                local newVirtText = {}
