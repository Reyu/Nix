...
return {
    ...
    },
    {
        ...
        keys = {
            { '<Leader>nl', function() require("noice").cmd('last') end, silent = true, desc = 'Last Notification' },
            { '<Leader>nh', function() require("noice").cmd('history') end, silent = true, desc = 'Notification History' },
    ...
    },
    {
        ...
        keys = {
            ...
            { '<S-A-h>', function() require('smart-splits').resize_left() end },
            { '<S-A-j>', function() require('smart-splits').resize_down() end },
            { '<S-A-k>', function() require('smart-splits').resize_up() end },
            { '<S-A-l>', function() require('smart-splits').resize_right() end },
            { '<M-h>', function() returnToNormal() require('smart-splits').move_cursor_left() end, mode = { 'n', 'i', 't' }},
            { '<M-j>', function() returnToNormal() require('smart-splits').move_cursor_down() end, mode = { 'n', 'i', 't' }},
            { '<M-k>', function() returnToNormal() require('smart-splits').move_cursor_up() end, mode = { 'n', 'i', 't' }},
            { '<M-l>', function() returnToNormal() require('smart-splits').move_cursor_right() end, mode = { 'n', 'i', 't' }},
        },
        config = function(_, opts)
            ...
            local buffer_hydra = Hydra({
                name = 'Barbar',
                config = {
                    on_key = function() vim.wait(200, function() vim.cmd 'redraw' end, 30, false) end
                },
                heads = {
