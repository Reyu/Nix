return {
    { "lewis6991/gitsigns.nvim", config = true, event = "VeryLazy" },
    {
        ...
        keys = {
            { '<F2>', function() require('dapui').toggle() end, desc = 'Toggle debug UI' },
            { '<F5>', function() require('dap').continue() end, desc = 'Start or Continue debug session' },
            { '<F10>', function() require('dap').step_over() end, desc = 'Run debugger for one step' },
            { '<F11>', function() require('dap').step_into() end, desc = 'Step into a function or method' },
            { '<F12>', function() require('dap').step_out() end, desc = 'Step out of a function or method' },
            { '<LocalLeader>db', function() require('dap').toggle_breakpoint() end, desc = 'Creates or removes a breakpoint' },
            { '<LocalLeader>dB', function() require('dap').set_breakpoint(vim.fn.input('Breakpoint condition: ')) end, desc = 'Set breakpoint w/ condition' },
            { '<LocalLeader>de', function() require('dap').set_exception_breakpoints() end, desc = 'Sets breakpoints on exceptions' },
            { '<LocalLeader>dl', function() require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end, desc = 'Set LogPoint' },
            { '<LocalLeader>dc', function() require('dap').clear_breakpoints() end, desc = 'Clear all breakpoints' },
            { '<LocalLeader>dr', function() require('dap').repl.open() end, desc = 'Open a REPL' },
            { '<LocalLeader>dR', function() require('dap').run_last() end, desc = 'Re-runs the last debug-adapter/configuration' },
            { '<LocalLeader>du', function() require('dapui').toggle() end, desc = 'Toggle debug UI' },
            ...
            Hydra({
             ...
             _<Esc>_: exit    _q_: Quit
                ...
                heads = {
                    ...
                    { 'p', function() require("dap").pause() end, { silent = true } },
