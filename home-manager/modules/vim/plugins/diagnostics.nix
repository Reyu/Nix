  ...
  neotest-haskell
  {
    ...
    config = ''
      if not vim.g.started_by_firenvim then
          ...
          vim.keymap.set('n', '<LocalLeader>ts', neotest.summary.toggle,
                         {desc = 'NeoTest Summary'})
          vim.keymap.set('n', '<LocalLeader>ta',
          ...
          vim.keymap.set('n', '<LocalLeader>td',
          ...
          end, {desc = 'Debug test suite'})
          vim.keymap.set('n', '<LocalLeader>to', neotest.output.open,
                         {desc = 'View output'})
          vim.keymap.set('n', '<LocalLeader>tO', neotest.output_panel.toggle,
                         {desc = 'Toggle output pannel'})
          vim.keymap.set('n', '<LocalLeader>tk', neotest.run.stop,
  ...
  }
  {
    ...
    config = ''
      if not vim.g.started_by_firenvim then
          ...
          vim.keymap.set('n', '<LocalLeader>xw',
                         '<CMD>TroubleToggle workspace_diagnostics<CR>', {
              silent = true,
              noremap = true,
              desc = 'Workspace diagnostics'
          })
          vim.keymap.set('n', '<LocalLeader>xd',
  ...
  }
  {
    ...
    config = ''
      if not vim.g.started_by_firenvim then
          ...
          vim.keymap.set('n', '<LocalLeader>du', require('dapui').toggle,
