    ...
    config = ''
      if not vim.g.started_by_firenvim then
        ...
        local map = function(lhs, rhs, desc)
          ...
          vim.keymap.set('t', lhs, function() returnToNormal() rhs() end, {desc = desc})
        end
        ...
        vim.keymap.set('n', '<Leader><Leader>h', smart_splits.swap_buf_left, {desc = 'Swap window to left'})
        vim.keymap.set('n', '<Leader><Leader>l', smart_splits.swap_buf_right, {desc = 'Swap window to right'})
        vim.keymap.set('n', '<Leader><Leader>j', smart_splits.swap_buf_down, {desc = 'Swap window below'})
        vim.keymap.set('n', '<Leader><Leader>k', smart_splits.swap_buf_up, {desc = 'Swap window above'})
      end
    '';
  }
  {
