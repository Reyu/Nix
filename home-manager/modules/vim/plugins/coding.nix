  ...
  }
  {
    ...
    config = ''
      if not vim.g.started_by_firenvim then
        ...
        vim.keymap.set('n', '<LocalLeader>nn', neogen.generate, {desc = 'Generate annotation'})
        vim.keymap.set('n', '<LocalLeader>nc', function() neogen.generate({type = 'class'}) end, {desc = 'Generate class annotation'})
        vim.keymap.set('n', '<LocalLeader>nf', function() neogen.generate({type = 'func'}) end, {desc = 'Generate function annotation'})
      end
    '';
  }
]
