...
let
  ...
  librewolfConfigPath = if isDarwin then "Library/Application Support/Librewolf" else ".librewolf";

  profilesPath = if isDarwin then "${librewolfConfigPath}/Profiles" else librewolfConfigPath;
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    home.file = mkMerge (
      [ { "${librewolfConfigPath}/profiles.ini" = mkIf (cfg.profiles != { }) { text = profilesIni; }; } ]
                          ...
                          processCustomEngineInput =
                            ...
                            // (
                              ...
                              // {
                                ...
                                loadPath = ''[home-manager]/programs.librewolf.profiles.${profile.name}.search.engines."${
